...
public class ProductRunner {
	public static void main(String[] args) {
		...
		ProductDTO product1 = new ProductDTO(1, "Laptop", 1299.99, LocalDate.of(2023, 11, 15),
				...
				"Electronics", 1.5, "Charger, Manual", "Intel Core i7", LocalDate.of(2023, 10, 1), "B07VXL3J5R", false,
				"India", "ModelX123", "SN12345", true, "2 Year Warranty", true, LocalDate.of(2023, 11, 18),
				LocalDate.of(2024, 1, 15));

		ProductDTO product2 = new ProductDTO(2, "Smartphone", 699.99, LocalDate.of(2023, 11, 20),
				LocalDate.of(2023, 10, 5), 0.15, "5G smartphone with dual camera", 100, 4, 50, 15, 18, 8, 7, 8,
				"Electronics", 0.7, "Charger, Earphones", "Snapdragon 865", LocalDate.of(2023, 10, 5), "B08DJSS2RG",
				false, "China", "ModelX123", "SN67890", true, "1 Year Warranty", false, LocalDate.of(2023, 11, 25),
		...
		Stream.of(product1, product2, product3, product4, product5, product6, product7, product8, product9, product10)
				.sorted(deliveryExpectedDateDescComparator).forEach(ref1 -> System.out.println(ref1));
		...
		Stream.of(product1, product2, product3, product4, product5, product6, product7, product8, product9, product10)
				.sorted(returnDateDescComparator).forEach(ref1 -> System.out.println(ref1));
		...
		Comparator<ProductDTO> nameAndAsin = (t1, t2) -> t1.getName().compareTo(t2.getPacker());
		...
		collections.stream().sorted(priceAndId).forEach(n -> System.out.println(n));
