...
<body>
	...
	<h1>Product details</h1>
		<div class="design">
	<label for="name" > Name </label><br><span id="nameError" style="color:red;"></span>
	...
	<script>
		function validateForm() {
			...
			if (productType === '') {
				...
				document.getElementById('productTypeError').innerHTML='Please select a product type.';
				return false;
		}
			else{
			...
			if (price <= 0 || price >= 5000) {
				//alert('Price must be greater than 0 and less than 5000.');
				document.getElementById('priceError').innerHTML='Price must be greater than 0 and less than 5000.';
				return false;
			}
			else{
			...
			if (brand.length < 3 || brand.length > 20) {
				...
				document.getElementById('brandError').innerHTML='Brand must be between 3 and 20 characters.';
				return false;
			}
			else{
			...
			if (quantity <= 1 || quantity >= 50) {
				...
				document.getElementById('quantityError').innerHTML='Brand must be between 3 and 20 characters.';
				return false;
			}
			else{
			...
			if (description.length > 30) {
				...
				document.getElementById('descriptionError').innerHTML='Description cannot exceed 30 words.';
				return false;
			}
			else{
