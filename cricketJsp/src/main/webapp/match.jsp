...
<style>
  ...
  #team1Error,
  #team2Error,
  #team1CaptainNameError,
  #team2CaptainNameError,
  #umpireNameError,
  #thirdUmpireNameError,
  #stadiumNameError,
  #stadiumCapacityError {
    font-size: 14px;
  }
</style>
...
<body>
	...
	<form action="india" method="post" class="container" name="myForm" onsubmit="return validateForm()">
	<h1>Match details</h1>
		<div class="design">
	<label for="tournamentName" > Tournament Name </label><br><span id="tournamentNameError" style='color:red;'></span>
  <input type="text" name="tournamentName" class="form-control" id="tournamentName" placeholder=" Enter tournament name">
</div><br>
	<div class="design">
			<label for="hostingCountry" >Hosting Country</label><span id="hostingCountryError" style='color:red;'></span> <select
...
<div class="design">
  ...
  <input type="date" name="matchDate"  id="matchDate"  required>
	...
	<div class="team1">
			<label for="team1" >Team 1</label><br><span id="team1Error" style='color:red;'></span> <select
			...
			<div class="team2">
			<label for="team1" >Team 2</label> <span id="team2Error" style='color:red;'></span><select
		...
		<div class="design">
	<label for="team1CaptainName" > Team1 Captain Name </label><br><span id="team1CaptainNameError" style='color:red;'></span>
  <input type="text" name="team1CaptainName" class="form-control" id="team1CaptainName" placeholder=" Enter Team1 Captain Name">
</div><br>
<div class="design">
	<label for="team2CaptainName" > Team2 Captain Name </label><br><span id="team2CaptainNameError" style='color:red;'></span>
  <input type="text" name="team2CaptainName" class="form-control" id="team2CaptainName" placeholder=" Enter Team2 Captain Name">
</div><br>
<div class="design">
	<label for="umpireName" >Umpire Name </label><br><span id="umpireNameError" style='color:red;'></span>
  <input type="text" name="umpireName" class="form-control" id="umpireName" placeholder="Enter Umpire Name">
</div><br>
<div class="design">
	<label for="thirdUmpireName" >Third Umpire Name </label><br><span id="thirdUmpireNameError" style='color:red;'></span>
  <input type="text" name="thirdUmpireName" class="form-control" id="thirdUmpireName" placeholder="Enter Third Umpire Name">
</div><br>
<div class="design">
	<label for="stadiumName" >Stadium Name </label><br><span id="stadiumNameError" style='color:red;'></span>
  <input type="text" name="stadiumName" class="form-control" id="stadiumName" placeholder="Enter Stadium Name">
</div><br>
<div class="design">
	<label for="stadiumCapacity" >Stadium Capacity </label><br><span id="stadiumCapacityError" style='color:red;'></span>
  <input type="number" name="stadiumCapacity" class="form-control" id="stadiumCapacity" placeholder="Ex: 1000000">
</div><br>
<div class="button">
