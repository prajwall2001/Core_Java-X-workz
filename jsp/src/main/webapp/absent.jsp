...
<body>
		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="navbarNav">
				<ul class="navbar-nav">
					...
					<li class="nav-item"><a class="nav-link" href="display.jsp">Display</a></li>
				</ul>
			</div>
		</div>
	</nav>
	<form action="prajwal" method="POST" class="container">
		...
		<textarea id="reason" name="reason" rows="1" cols="50">
		</textarea>
		...
		<label>No</label> <br> <input type="submit" value="Submit"
